        ...
        <Card >
          ...
          <CardContent>
            <Typography variant="body2" color="text.secondary">
                Rick and Morty is an American adult animated science-fiction sitcom created by Justin Roiland and Dan Harmon for Cartoon Networks nighttime programming block Adult Swim.
                It is distributed internationally by Warner Bros. Domestic Television.
            </Typography>
            &nbsp;
            <Typography variant="body2" color="text.secondary">
              The series follows the misadventures of cynical mad scientist Rick Sanchez and his good-hearted but fretful grandson Morty Smith,
              ...
              often travelling to other planets and dimensions through portals and on Rick flying saucer.
            </Typography>
            &nbsp;
            <Typography variant="body2" color="text.secondary">
